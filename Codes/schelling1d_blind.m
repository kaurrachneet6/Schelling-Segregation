%Rachneet Kaur
%Activated switching agents activated after half time and moves are blind
function [contact susep] = schelling1d_blind(lattice,dummylattice,toler,l_size)
figure
disp(lattice);
max = 500;
visit= zeros(l_size);
...
title('Segregation model with activated switching agents after half time');
pause(0.015);
end
