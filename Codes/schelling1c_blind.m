%Rachneet Kaur
%Activated switching agents activated in the beginning itself and moves are blind
function [contact susep] = schelling1c_blind(lattice,dummylattice,toler,l_size)
figure
disp(lattice);
max = 500;
visit= zeros(l_size);
